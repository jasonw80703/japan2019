  ...
  return (
    <div>
      ...
      <Preload
        ...
        images={[
          getS3ObjectImagePath('sapporo/pocketwifi'),
          getS3ObjectImagePath('sapporo/hostel'),
          getS3ObjectImagePath('sapporo/kalbi'),
          getS3ObjectImagePath('sapporo/street'),
          getS3ObjectImagePath('sapporo/city'),
          getS3ObjectImagePath('sapporo/park'),
          getS3ObjectImagePath('sapporo/cup'),
          getS3ObjectImagePath('sapporo/tower'),
          getS3ObjectImagePath('sapporo/pages'),
          getS3ObjectImagePath('sapporo/entrance'),
